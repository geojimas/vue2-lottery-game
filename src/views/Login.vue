            ...
            <div class="flex flex-col mb-6">
              ...
              <div class="relative">
                <ValidationProvider name="password" rules="required" v-slot="{ errors }">
                  ...
                  />
                  <h1 class="mt-2 ml-4 text-red-500 underline">{{ errors[0] }}</h1>
                </ValidationProvider>
              </div>
            </div>
            ...
            <div>
              <div class="flex justify-center items-center mt-6">
                <span class="ml-2"
                  ...
                  <router-link
                    to="/register"
                    class="ml-2 text-blue-500 font-semibold hover:underline"
...
export default {
  ...
  methods: {
    login() {
      axios
        .post(
          'https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyDRRNETurSnjMHKOSutDtYiVLz8jM7AkqM',
          {
